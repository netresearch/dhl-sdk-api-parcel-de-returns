...
namespace Dhl\Sdk\ParcelDe\Returns\Http\ClientPlugin;
...
final class ReturnLabelErrorPlugin implements Plugin
{
    ...
    {
        if (isset($responseData['status'], $responseData['detail'])) {
            return sprintf('%s (Error %s)', $responseData['detail'], $responseData['status']);
        }
